...
# 제목
st.title("👗 뭐 입을지 고민하지 말고 코디 추천 받자!")
...
if choice == "사과형 🍎 (상체가 발달한 체형)":
    ...
    st.image("https://search.pstatic.net/common/?src=http%3A%2F%2Fblogfiles.naver.net%2FMjAyNDA4MzFfMjA5%2FMDAxNzI1MDQ2NTMwMDE0.tuOOfTW2SQO9mUbyQH5cUi7GMcRcIWZyVui3yF_Y5_Ug.mOiLUfo_QWsm3_Za9fjY3DoRfEDBFGplJvq5j4XAnCwg.JPEG%2FIMG_1937.jpg&type=sc960_832", caption="모래시계형 코디 예시", use_container_width=True)
